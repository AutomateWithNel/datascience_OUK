...
# Module 06 - Practical Task

## Prompt

Dataset: `compact.csv` from Our World in Data COVID compact dataset.

Tasks:
1. Plot the trend of confirmed cases over time for the top 3 countries.
2. Create a bar chart showing the total number of confirmed cases for the top 10 countries.
3. Create an interactive line chart showing the trend of confirmed cases over time for the top 3 countries.
4. Create an interactive bar chart to show the total number of deaths for the top 10 countries.
...
- Keep `compact.csv` in the same folder as `Module6Practical.py`.
